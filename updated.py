...
class SentimentNetwork:
    ...
    def pre_process_data(self, reviews, labels):
        ...
        for review in reviews:
            review_vocab.update({x for x in review.split(" ")})
    ...
    def init_network(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        self.weights_1_2 = np.random.normal(0, self.hidden_nodes ** -0.5, 
    ...
    def train(self, training_reviews_raw, training_labels):
        ...
        for i in range(len(training_reviews_raw)):
            ...
            layer_1_delta = layer_1_error * 1 # no non-linear activation in this case so it is error * 1
